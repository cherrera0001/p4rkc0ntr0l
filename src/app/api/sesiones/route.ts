 ...
 */
export const GET = rutaAutenticada(
  // **Sin comprobación de origen, igual que hasta ahora.** Un GET de otro
  // sitio no lo puede leer el atacante por CORS, y agregarla acá sería colar
  // una decisión de seguridad dentro de un refactor. Va explícita en cada
  // ruta y no como default silencioso, para que la asimetría se vea.
  { rol: "operador", exigirOrigen: false },
  async ({ sesion: operador }) => {
    try {
